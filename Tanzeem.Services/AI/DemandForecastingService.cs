    ...
    ICurrentService _currentService, IConfiguration _configuration) : IDemandForecastingService
{
    ...
    //        // تم حذف السطر اللي بيعمل ToDictionaryAsync هنا عشان نتفادى إيرور تكرار الـ ProductId
    ...
    //    // تم حذف السطر اللي بيعمل ToDictionaryAsync هنا
    ...
    //// تم تعديل الميثود هنا للبحث مباشرة في الداتابيز بالتاريخ والمنتج معاً
